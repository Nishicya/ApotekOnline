...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form id="pembelianForm" method="POST" action="{{ route('pembelian.update', $pembelian->id) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_nota" 
                                   value="{{ $pembelian->no_nota }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_pembelian') is-invalid @enderror" 
                                   ...
                                   value="{{ old('tgl_pembelian', $pembelian->tgl_pembelian->format('Y-m-d')) }}">
                            @error('tgl_pembelian')
                    ...
                    <select class="form-control select2 @error('id_distributor') is-invalid @enderror" 
                        ...
                        @foreach($distributors as $distributor)
                            <option value="{{ $distributor->id }}" 
                                {{ old('id_distributor', $pembelian->id_distributor) == $distributor->id ? 'selected' : '' }}>
                ...
                <div id="obatContainer">
                    @php
                        $oldObatId = old('obat_id', $pembelian->detailPembelians->pluck('id_obat')->toArray());
                        $oldJumlah = old('jumlah', $pembelian->detailPembelians->pluck('jumlah')->toArray());
                        $oldHargaBeli = old('harga_beli', $pembelian->detailPembelians->pluck('harga_beli')->toArray());
                    @endphp
                    
                    @foreach($oldObatId as $index => $obatId)
                    <div class="row obat-row mb-3 g-3 align-items-center">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control jumlah" 
                                   ...
                                   value="{{ $oldJumlah[$index] }}" required>
                            @error('jumlah.'.$index)
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control harga" 
                                       ...
                                       value="{{ $oldHargaBeli[$index] }}" required>
                            </div>
    ...
    $('#addObat').click(function() {
        const newRow = `
            <div class="row obat-row mb-3 g-3 align-items-center">
                ...
                <div class="col-md-2">
                    <input type="number" class="form-control jumlah" name="jumlah[]" placeholder="Qty" min="1" value="1" required>
                </div>
                <div class="col-md-2">
                    <div class="input-group">
                        <span class="input-group-text">Rp</span>
                        <input type="number" class="form-control harga" name="harga_beli[]" placeholder="Harga" min="0" step="100" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="input-group">
