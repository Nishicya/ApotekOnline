...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('jenis-obat.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                
                <div class="form-group">
                    <label for="jenis">Type Name</label>
                    <input type="text" class="form-control" id="jenis" name="jenis" 
                           placeholder="Type name" value="{{ old('jenis') }}">
                    @error('jenis')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="deskripsi_jenis" name="deskripsi_jenis" 
                              rows="4" placeholder="Type description">{{ old('deskripsi_jenis') }}</textarea>
