...
<body>
    <div class="container">
        ...
        <div class="form-box register">
            <form method="POST" action="{{ route('signup-user') }}">
                ...
                <div class="input-box">
                    <input name="no_hp" type="text" class="form-control form-control-lg" id="no_hp" placeholder="Phone Number" required value="{{ old('no_hp') }}">
    ...
    <script src="{{asset('auth/register/main.js')}}"></script>
</body>
</html>